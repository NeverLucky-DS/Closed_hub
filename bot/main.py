...
from bot.handlers.library_cmd import files_command, links_command, resources_command, search_command
...
def main() -> None:
    ...
    app.add_handler(CommandHandler("resources", resources_command, filters=private))
