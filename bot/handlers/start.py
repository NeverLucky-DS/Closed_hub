...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.effective_message.reply_text(
        ...
        "Снизу — главное меню: «Собесы», «Сайт» (логин на веб-хаб) и «Как пользоваться». "
        ...
        "Поиск по материалам: /search тема, отдельно файлы — /files тема, полезные ссылки — /links тема.\n\n"
